...
public class TestJoueur {
    ...
    public static void testAjouterCarte(){
        ...
        final Carte[] CARTE_A_AJOUTER = { new Carte(213), new Carte (111), new Carte (408) };

        final Carte[] MAIN_ATTENDU = {

                new Carte(213), new Carte (103), new Carte (108), new Carte (113),
                new Carte (114), new Carte (202), new Carte (111), new Carte (214),
                new Carte (302), new Carte (308), new Carte (314), new Carte (402),
                new Carte (408)
        };
